  ...
  return (
    <footer className="bg-slate-50">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="py-16">
          <svg className="mx-auto h-20 w-auto" stroke="currentColor" fill="#62C5C1" stroke-width="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex flex-col items-center py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6"><a className="group" aria-label="TaxPal on Twitter" href="https://twitter.com">
            ...
            <a className="group" aria-label="TaxPal on GitHub" href="https://github.com">
              <svg aria-hidden="true" className="h-6 w-6 fill-slate-500 group-hover:fill-slate-700">
